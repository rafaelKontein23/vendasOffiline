...
class DialogProgressiva {
    ...
    fun dialog(context:Context, valorpfatual:Double,
               nomeremedio:String, protudoProgressiva: ProdutoProgressiva, AtualizaProgressiva: visaogrupo.com.br.modulo_visitacao.Views.Models.Class.Interfaces.Ondimiss.AtualizaProgressiva
    ){
        var valornovo = 0.0
